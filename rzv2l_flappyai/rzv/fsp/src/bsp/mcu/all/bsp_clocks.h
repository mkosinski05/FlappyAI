 ...
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 1.
 **********************************************************************************************************************/
#define BSP_CLKON_BIT_BSP_CLK_DMAC(ch)                (1U << (R_CPG_CPG_CLKON_DMAC_CLK0_ON_Pos + (ch)))
 ...
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 1.
 **********************************************************************************************************************/
#define BSP_CLKMON_BIT_BSP_CLK_DMAC(ch)               (1U << (R_CPG_CPG_CLKMON_DMAC_CLK0_MON_Pos + (ch)))
 ...
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 1.
 **********************************************************************************************************************/
#define BSP_RST_BIT_BSP_CLK_DMAC(ch)                  (1U << (R_CPG_CPG_RST_DMAC_UNIT0_RSTB_Pos + (ch)))
 ...
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 1.
 **********************************************************************************************************************/
#define BSP_RSTMON_BIT_BSP_CLK_DMAC(ch)               (1U << (R_CPG_CPG_RSTMON_DMAC_RST0_MON_Pos + (ch)))
