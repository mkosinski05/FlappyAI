...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t CPG_RSTMON_OSTM;
        struct
        {
            __IOM uint32_t RST0_MON : 1;
            __IOM uint32_t RST1_MON : 1;
